...
TEST_CASE("Grid: Square Image") {
  ...
  SECTION("Number of x grid points should equal 63") { CHECK(g.numX() == 63); }

  SECTION("Number of y grid points should equal 63") { CHECK(g.numY() == 63); }
  ...
  SECTION("Total grid points should equal 3969") { CHECK(g.size() == 3969); }
...
TEST_CASE("Grid: Rectangular Image") {
  ...
  SECTION("Number of x grid points should equal 31") { CHECK(g.numX() == 31); }
  ...
  SECTION("Total grid points should equal 1956") { CHECK(g.size() == 1953); }
